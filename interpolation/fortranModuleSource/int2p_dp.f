C This file is adapted from the NCL 6.1.2 source code.  See
C ../externalLicenes/NCAR.txt for full copyright information.
C
C Copyright 2007-2013 University Corporation for Atmospheric Research (UCAR).
C All rights reserved. Developed by NCAR's Computational and Information Systems
C Laboratory, UCAR, www.cisl.ucar.edu
